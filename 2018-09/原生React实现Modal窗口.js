...
// 在不使用bootstrap或者reactStrap情况下实现react下的modal
// 整体modal分为四部分：整体黑色半透明背景，头部-中间-尾部内容，转换过程需要动画
// 接口分析：isOpen、head-body-footer内容、cancelText/OKText、cancel-ok call-back function
// 动画分析：使用react-motion动画，此时不使用css-transition动画
// 注意事项：react版本变化，所以代码可能需要不断调整，选择更好的modal方式
