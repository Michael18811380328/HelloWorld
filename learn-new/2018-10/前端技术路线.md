...
PS（11.04）前端技术路线在不断变化；这个文本是两年前左右的技术体系，对于angular 和 jquery 等依赖性很强。现在的前端新的方向注意更新，对于新知识和面向对象的新潮流要及时适应。当前前端的逻辑业务增加，对于传统的图片处理不是很多要求（当然不同平台可能有新的技术要求，自己要全面综合发展）。
