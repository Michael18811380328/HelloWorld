...
- API
  - [Set up an instance](https://github.com/segmentio/nightmare#nightmareoptions)
  - [Interact with the page](https://github.com/segmentio/nightmare#interact-with-the-page)
  - [Extract from the page](https://github.com/segmentio/nightmare#extract-from-the-page)
  - [Cookies](https://github.com/segmentio/nightmare#cookies)
  - [Proxies](https://github.com/segmentio/nightmare#proxies)
  - [Promises](https://github.com/segmentio/nightmare#promises)
  - [Extending Nightmare](https://github.com/segmentio/nightmare#extending-nightmare)
- [Usage](https://github.com/segmentio/nightmare#usage)
- [Debugging](https://github.com/segmentio/nightmare#debugging)
- [Additional Resources](https://github.com/segmentio/nightmare#additional-resources)
...
You can also adjust how long `goto` will wait before timing out by setting the [`gotoTimeout` option](https://github.com/segmentio/nightmare#gototimeout-default-30s) on the Nightmare constructor.
...
Proxies are supported in Nightmare through [switches](https://github.com/segmentio/nightmare#switches).

If your proxy requires authentication you also need the [authentication](https://github.com/segmentio/nightmare#authenticationuser-password) call.
...
2. Pass `{ show: true }` to the [nightmare constructor](https://github.com/segmentio/nightmare#nightmareoptions) to have it create a visible, rendered window where you can watch what is happening.
3. Listen for [specific events](https://github.com/segmentio/nightmare#onevent-callback).
