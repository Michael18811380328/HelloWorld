function t(t) {
    ...
    for (var r, e = t[0], n = 0, o = 1; o < t.length; o++) r = e + t[o],
...
function e(t, e) {
    var n, o, a = r(t),
    i = 0;
    if (2 === e) for (o = 0; o < t.length; o++) i += (n = t[o] - a) * n;
    else for (o = 0; o < t.length; o++) i += Math.pow(t[o] - a, e);
    return i
}
function n(t) {
...
function f(t, r, e, n) {
    for (e = e || 0, n = n || t.length - 1; n > e;) {
        if (n - e > 600) {
            ...
            a - o / 2 < 0 && (u *= -1),
            f(t, r, Math.max(e, Math.floor(r - a * s / o + u)), Math.min(n, Math.floor(r + (o - a) * s / o + u)))
        }
        var h = t[r],
        p = e,
        c = n;
...
function p(t, r) {
        ...
        function(t, r) {
            ...
            for (var o = [0, e.length - 1]; o.length;) {
                ...
                if (! (a - i <= 1)) {
                    ...
                    c(t, e[s], Math.floor(e[i]), Math.ceil(e[a])),
                    o.push(i, s, s, a)
                }
            }
        } (e, r);
    ...
    return c(e, v(e.length, r), 0, e.length - 1),
    h(e, r)
}
function c(t, r, e, n) {
...
function w(t, r) {
    ...
    var e = function(t, r) {
        for (var e = 0,
        n = 0,
        o = t.length; n < o;) r <= t[e = n + o >>> 1] ? o = e: n = -~e;
        return n
    } (t, r);
    ...
    var n = function(t, r) {
        for (var e = 0,
        n = 0,
        o = t.length; n < o;) r >= t[e = n + o >>> 1] ? n = -~e: o = e;
        return n
    } (t, r);
...
function d(t, r) {
    r = r || Math.random;
    for (var e, n, o = t.length; o > 0;) n = Math.floor(r() * o--),
    e = t[o],
    t[o] = t[n],
    t[n] = e;
    return t
...
function q(t) {
    for (var r, e = 0,
    n = 0; n < t.length; n++) 0 !== n && t[n] === r || (r = t[n], e++);
    return e
}
function E(t, r) {
    for (var e = [], n = 0; n < t; n++) {
...
function S(t, r, e, n, o, a, i) {
    if (! (t > r)) {
        ...
        o[e][s] = s;
        var u = e;
        t > e && (u = Math.max(u, o[e][t - 1] || 0)),
        u = Math.max(u, o[e - 1][s] || 0);
        var h, f, l, p = s - 1;
        r < n.length - 1 && (p = Math.min(p, o[e][r + 1] || 0));
        for (var c = p; c >= u && !((h = y(c, s, a, i)) + n[e - 1][u - 1] >= n[e][s]); --c)(f = y(u, s, a, i) + n[e - 1][u - 1]) < n[e][s] && (n[e][s] = f, o[e][s] = u),
        u++,
        (l = h + n[e - 1][c - 1]) < n[e][s] && (n[e][s] = l, o[e][s] = c);
        S(t, s - 1, e, n, o, a, i),
        S(s + 1, r, e, n, o, a, i)
    }
}
...
function C(t) {
    ...
    for (var r = 0,
    e = 0; e < t.length; e++) r += Math.pow(t[e], 2);
...
T.prototype.train = function(t, r) {
    for (var e in this.data[r] || (this.data[r] = {}), t) {
        var n = t[e];
        void 0 === this.data[r][e] && (this.data[r][e] = {}),
        void 0 === this.data[r][e][n] && (this.data[r][e][n] = 0),
        this.data[r][e][n]++
    }
    this.totalCount++
},
T.prototype.score = function(t) {
    ...
    for (var n in t) {
        var o = t[n];
        for (r in this.data) e[r] = {},
        e[r][n + "_" + o] = this.data[r][n] ? (this.data[r][n][o] || 0) / this.totalCount: 0
    }
    var a = {};
    for (r in e) for (var i in a[r] = 0, e[r]) a[r] += e[r][i];
    return a
};
var N = function() {
    this.weights = [],
...
N.prototype.predict = function(t) {
    ...
    for (var r = 0,
    e = 0; e < this.weights.length; e++) r += this.weights[e] * t[e];
...
N.prototype.train = function(t, r) {
    ...
    if ("number" == typeof e && e !== r) {
        for (var n = r - e,
        o = 0; o < this.weights.length; o++) this.weights[o] += n * t[o];
        this.bias += n
    }
    return this
};
...
B = {
    nrd: function(t) {
        var r = P(t),
        e = M(t);
        return "number" == typeof e && (r = Math.min(r, e / 1.34)),
        1.06 * r * Math.pow(t.length, -.2)
    }
};
function K(t, r, e) {
    var n, o;
...
exports.rSquared = function(t, r) {
    ...
    for (var e = 0,
    n = 0; n < t.length; n++) e += t[n][1];
    for (var o = e / t.length,
    a = 0,
    i = 0; i < t.length; i++) a += Math.pow(o - t[i][1], 2);
    for (var s = 0,
    u = 0; u < t.length; u++) s += Math.pow(t[u][1] - r(t[u][0]), 2);
    return 1 - s / a
},
...
exports.extent = function(t) {
    ...
    for (var r = t[0], e = t[0], n = 1; n < t.length; n++) t[n] > e && (e = t[n]),
    t[n] < r && (r = t[n]);
    return [r, e]
},
...
exports.shuffle = b,
exports.shuffleInPlace = d,
exports.sample = function(t, r, e) {
...
exports.ckmeans = function(t, r) {
    ...
    o = E(r, e.length); !
    function(t, r, e) {
        for (var n = r[0].length, o = t[Math.floor(n / 2)], a = [], i = [], s = 0, u = void 0; s < n; ++s) u = t[s] - o,
        0 === s ? (a.push(u), i.push(u * u)) : (a.push(a[s - 1] + u), i.push(i[s - 1] + u * u)),
        r[0][s] = y(0, s, a, i),
        e[0][s] = 0;
...
exports.sampleSkewness = function(t) {
    ...
    for (var e, n = r(t), o = 0, a = 0, i = 0; i < t.length; i++) o += (e = t[i] - n) * e,
    a += e * e * e;
...
exports.sampleKurtosis = function(t) {
    ...
    for (var n, o = r(t), a = 0, i = 0, s = 0; s < e; s++) a += (n = t[s] - o) * n,
    i += n * n * n * n;
...
exports.permutationsHeap = function(t) {
    ...
    for (var o = 0; o < t.length;) if (r[o] < o) {
        var a = 0;
        o % 2 != 0 && (a = r[o]);
        var i = t[a];
        t[a] = t[o],
...
exports.combinations = function t(r, e) {
    var n, o, a, i, s = [];
    for (n = 0; n < r.length; n++) if (1 === e) s.push([r[n]]);
    else for (a = t(r.slice(n + 1, r.length), e - 1), o = 0; o < a.length; o++)(i = a[o]).unshift(r[n]),
    s.push(i);
    return s
},
exports.combinationsReplacement = function t(r, e) {
    for (var n = [], o = 0; o < r.length; o++) if (1 === e) n.push([r[o]]);
    else for (var a = t(r.slice(o, r.length), e - 1), i = 0; i < a.length; i++) n.push([r[o]].concat(a[i]));
    return n
},
...
exports.chiSquaredGoodnessOfFit = function(t, e, n) {
    for (var o = 0,
    a = e(r(t)), i = [], s = [], u = 0; u < t.length; u++) void 0 === i[t[u]] && (i[t[u]] = 0),
    i[t[u]]++;
...
exports.permutationTest = function(t, e, n, o) {
    ...
    var c = 0;
    if ("two_side" === n) for (var g = 0; g <= o; g++) Math.abs(i[g]) >= Math.abs(a) && (c += 1);
    else if ("greater" === n) for (var v = 0; v <= o; v++) i[v] >= a && (c += 1);
    else for (var w = 0; w <= o; w++) i[w] <= a && (c += 1);
    return c / o
},
