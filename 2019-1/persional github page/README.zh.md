...
### [我的博客在这里 &rarr;](https://00feng00.github.io/)
...
* 如果你喜欢我的这个博客模板，请在`https://00feng00.github.io/`这个repository点个赞——右上角**star**一下。
...
```
# Site settings
title: ZeFeng Blog             # 你的博客网站标题
SEOTitle: ZeFeng Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: zeFengpro     # 你的github账号
weibo_username: zeFengpro      # 你的微博账号，底部链接会自动更新的。
...
我的博客标题是 **“Feng Blog”** 但是我想要在搜索的时候显示 **“泽锋的博客 | Feng Blog”** ，这个就需要SEO Title来定义了。
