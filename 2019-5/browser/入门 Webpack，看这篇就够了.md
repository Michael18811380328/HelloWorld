...
- [模块化开发](https://segmentfault.com/t/模块化开发/blogs)
-  
...
> 2018年8月25日更新，目前 webpack 已经更新值 4.17.1 ，本文所用到的各种库或多或少有些过时，跟着代码操作下来可能会遇到各种问题，不过 webpack 的主体思想没变，所以还是希望本文对新学 webpack 的你，有所帮助。此外用基于 webpack 4.17.1
>
>  
>
> 写了一个简单的demo，如果遇到啥问题，可以参考
>
> ，之后应该会逐步来完善这个demo，如果有啥通用的想实现的功能，也可以在里面提 issue。
>
> 2017年12月7日更新，添加了`clean-webpack-plugin`,`babel-env-preset`,添加本文涉及到的所有代码的示例，~~如果你在学习过程中出错了，可点击此处参考(有些过时了，不要再 fork 了)~~
...
> 真的非常好用，希望大家都能用上。
>
> 2017年9月18日更新，添加了一个使用`webpack`配置多页应用的demo,可以点击[此处查看](https://github.com/zhangwang1990/blogs/tree/master/sources/MultiPageWebpackDemos)
>
...
> ![webpack从入门到工程实践](https://segmentfault.com/img/remote/1460000010874491)