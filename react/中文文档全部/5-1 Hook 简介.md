...
**你将在[下一章节](https://zh-hans.reactjs.org/docs/hooks-overview.html)正式开始学习 Hook。** 这一章节，我们将会解释为什么会在 React 中加入 Hook，以及如何使用 Hook 写出更好的应用。
...
**如果不想了解添加 Hook 的具体原因，可以直接[跳到下一章节开始学习 Hook！](https://zh-hans.reactjs.org/docs/hooks-overview.html)** 当然你也可以继续阅读这一章节来了解原因，并且可以学习到如何在不重写应用的情况下使用 Hook。
...
> 示例
>
> [Hook 概览](https://zh-hans.reactjs.org/docs/hooks-overview.html)是开始学习 Hook 的不错选择。
